inherited FrmCadProced: TFrmCadProced
  ...
  object Label3: TLabel [2]
    ...
    Height = 13
    Alignment = taCenter
    Caption = 'Produtos Usados no Procedimento'
  end
  ...
  object DBGrid1: TDBGrid [8]
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'Qtd_uso_procedimento'
        Title.Caption = 'Qtd'
        Width = 53
        Visible = True
      end>
  end
  object EdtCodProd: TEdit [9]
    Left = 8
    Top = 128
    Width = 49
    Height = 21
  ...
  object BtnInsereItem: TBitBtn [11]
    Left = 361
    Top = 126
    Width = 48
    Height = 25
    ...
    TabOrder = 7
    OnClick = BtnInsereItemClick
  end
  object EdtQtdProd: TEdit [12]
    Left = 314
    Top = 128
    Width = 41
    Height = 21
  ...
  object EdtCodInterno: TEdit [13]
    Left = 8
    Top = 80
    Width = 49
    Height = 21
    TabOrder = 1
    OnKeyPress = EdtCodInternoKeyPress
  end
  ...
  object FDConsulta: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select * from item_procedimento as i inner join produtos as p on' +
        ' i.cod_produto = p.id_produto')
    Left = 347
    Top = 200
  end
