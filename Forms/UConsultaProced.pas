...
begin
  ...
  begin
     //     CONSULTA CADASTRO DE AGENDAMENTO     //
    ...
    //      CONSULTA CADASTRO AGENDAMENTO       //

    else
    if FrmConsultaProced.Tag = 1 then
    begin
      FrmCadProced.EdtNomeProc.Text := FDQuery1.FieldByName('DESCRICAO').AsString;
      FrmCadProced.EdtCodInterno.Text := FDQuery1.FieldByName('CODIGO').AsString;
    end;


      //     FECHAR APÓS SELECIONAR             //
