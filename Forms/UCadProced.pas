...
type
  TFrmCadProced = class(TFrmCadPai)
    ...
    procedure excluirregistro_item;
...
begin
  inherited;
  if EdtCodInterno.Text <> '' then
  begin
    excluirregistro_item;
    excluirregistro;
    EdtCodInterno.Text := '';
    EdtCodProd.Text := '';
    EdtQtdProd.Text := '';
...
begin
  FDQuery1.Close;
  FDQuery1.SQL.Clear;
  FDQuery1.SQL.Add('DELETE FROM PROCEDIMENTOS WHERE CODIGO = ' + EdtCodInterno.Text);
  FDQuery1.ExecSQL;
end;


procedure TFrmCadProced.excluirregistro_item;
begin
  FDQuery1.Close;
  FDQuery1.SQL.Clear;
