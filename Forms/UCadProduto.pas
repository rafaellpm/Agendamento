...
begin
  ...
  FDQuery1.SQL.Add('(ID_PRODUTO, DESCRICAO, COD_EAN, ID_FORNECEDOR, ID_DEPARTAMENTO, ID_SUBDEPARTAMENTO, QTD_ESTOQUE, TIPO_PRODUTO, PRECO_CUSTO, PRECO_VENDA, DATA_CADASTRO, ULTIMA_ALTERACAO, ATIVO)');
  ...
  FDQuery1.close;
  FDQuery1.SQL.Clear;
  FDQuery1.SQL.Add('INSERT INTO ESTOQUE');
  FDQuery1.SQL.Add('(COD_PRODUTO, QTD_ESTOQUE)');
  FDQuery1.SQL.Add('VALUES ');
  FDQuery1.SQL.Add('(:COD_PRODUTO, :QTD_ESTOQUE)');
  FDQuery1.Params.ParamByName('COD_PRODUTO').Value := StrToInt(EdtCodInterno.Text);
