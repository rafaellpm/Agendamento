...
type
  TFrmCadAgendamento = class(TFrmCadPai)
    ...
    procedure EdtCodProcedimentoKeyPress(Sender: TObject; var Key: Char);
  private
...
uses
  UConsultaCliente, UConsultaProced;
...
procedure TFrmCadAgendamento.EdtCodProcedimentoKeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
  FrmConsultaProced := TFrmConsultaProced.Create(self);
  try
    FrmConsultaProced.Tag := 0;
